...
class Slim {
    ...
    public static function saveFile($user_id, $username, $data, $name, $path = 'tmp/', $uid = true) {
        ...
        $wpdb->query( $wpdb->prepare( "UPDATE {$wpdb->prefix}userprofile SET profile = %s, date_updated = %s WHERE user_id = %d", $image_upload,$date_updated,$user_id ) );
